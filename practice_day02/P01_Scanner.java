...
üçgenin alanını hesaplayıp yazdırın
        ...
        System.out.println("Lütfen alanı hesaplanacak olan ücgenin ilgili ayrıt degerlerini giriniz");
        System.out.println("Üçgenin bir kenarının uzunlugunu giriniz: ");
        double kenar = scan.nextDouble();
        System.out.println("O kenara ait yüksekligi giriniz: ");
        double yukseklik = scan.nextDouble();
        System.out.println("======================Bilgilerin girilen ucgenin Alan Hesabı Sonucu ===============");
